...
class PresentationStudyWrongQuestions : BaseContentFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val rootView = inflater.inflate(R.layout.presentation_study_wrong_questions, container, false)!!
    ...
    private val mItIsUnderstandedListener = View.OnClickListener(){
        ...
        goStudyWrongQuestionFragment()
    }

    private fun goStudyWrongQuestionFragment() {
        val transaction = fragmentManager!!.beginTransaction()
        transaction.replace(R.id.study_wrong_question_fragment_container, StudyWrongQuestionFragment())
        transaction.commit()
    }
}